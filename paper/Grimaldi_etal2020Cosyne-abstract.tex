...
%%%-----------------------------------------------------------------
 %%%-----------------------------------------------------------------angelo_1
%You should state why this is true at some point. It's a comment we got many times when we worked with homeostasis
%%%-----------------------------------------------------------------
...
%%%-----------------------------------------------------------------victor_2
%You speak about euclidian distance for \beta… It is actually the cosine similarity, and not the Euclidian distance. You should update accordingly.
%%%-----------------------------------------------------------------
...
\paragraph*{Figure 2 : }
%%%-----------------------------------------------------------------gregor_1
%your results are nice. But visual comparison is a bit difficult. Check Figure 8 in this paper: https://www.frontiersin.org/articles/10.3389/fnins.2018.01047/full
%they sort the features to make comparison easier
%%%-----------------------------------------------------------------
...
%%%-----------------------------------------------------------------gregor_2
%'aka' is too informal. Also, surfaces are maybe derived from spiking input, they are not equivalent
%%%-----------------------------------------------------------------
...
%%%-----------------------------------------------------------------
%%%-----------------------------------------------------------------victor_3 (pour le futur)
%You are doing a great job at showing that the homeostasis ‘qualitatively’ improve the shape of the learned features. But it would be great if you also show that it is also improving the classification accuracy. You are not explicitly making the comparison. You should do it (provided you have convincing results).
%%%-----------------------------------------------------------------
%
...
%%%-----------------------------------------------------------------
%%%-----------------------------------------------------------------gregor_3
%put the comparison of results in here. if you lack space, write them in text
%%%-----------------------------------------------------------------
%
...
%%%-----------------------------------------------------------------angelo_2
%is competition a way of implementing homeostasis? it might be not clear...
%%%-----------------------------------------------------------------
%%%-----------------------------------------------------------------gregor_4
%Nice summary overall. It would be nice if you could explain how time surfaces have a connection to neuroscience (if there is one). It would further be nice to compare to other works in terms of classification accuracy, # of neurons, # of spikes, latency,... etc to make it easier for people to know where this work stands in comparison to other methods.
%%%-----------------------------------------------------------------
