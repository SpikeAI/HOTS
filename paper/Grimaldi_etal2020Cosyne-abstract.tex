...
With a simple Hebbian learning rule, see ~\citep{Lagorce17}, neurons learn patterns from spiking input aka time-surfaces.
...
As observed in \textit{Figure 2(D)} adding an homeostatic gain favoring rarely activated neurons can improve learning of the weights and make a more efficient coding of the spiking input. 
%
